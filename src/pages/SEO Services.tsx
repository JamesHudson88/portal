...
const SEO = () =>  {
  ...
  const services = [
    {
      ...
      price: '30,000 PKR',
      image: '/public/icons/SEO Audit & Optimization.png',
      bgColor: 'bg-blue-50'
    },
    {
      ...
      price: '90,000 PKR',
  image: '/public/icons/PPC Campaign Management.png',
      bgColor: 'bg-green-50'
    },
    {
      ...
      delivery: '10-14 Business Days',
      price: '60,000 PKR',
  image: '/public/icons/Email Marketing Campaign.png',
      bgColor: 'bg-purple-50'
    },
    {
      id: 'YouTube Marketing & SEO',
      name: ' YouTube Marketing & SEO',
      category: 'SEO Services',
      delivery: '7-10 Business Days',
      price: '35,000 PKR',
  image: '/public/icons/YouTube Marketing & SEO.png',
    ...
    },
    {
      ...
      delivery: '7-10 Business Days',
      price: '45,000 PKR',
  image: '/public/icons/Content Marketing.png',
      bgColor: 'bg-red-50'
    }
  ];
  ...
  { title: "SEO Services", icon: SearchIcon, active: true, path: "/SEO" },
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex items-center justify-left gap-x-60 mt-4 px-6">
                ...
                <div className="flex items-center space-x-4 ">
                  ...
                  <span className="text-gray-800 font-medium">SEO Services</span>
                </div>
