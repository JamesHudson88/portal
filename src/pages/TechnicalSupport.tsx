...
const Techsupport = () =>  {
  ...
  const services = [
    {
      id: 'Remote IT Troubleshooting',
      name: 'Remote IT Troubleshooting',
  ...
  image: '/public/icons/Business Website.png',
    ...
    {
      id: 'CRM Deployment & Configuratio',
      name: 'CRM Deployment & Configuratio',
      category: 'Technical support',
  ...
  image: '/public/icons/Professional Portfolio.png',
    ...
    {
      id: 'Firewall & Antivirus Setup',
      name: 'Firewall & Antivirus Setup',
      category: 'Technical support',
      delivery: '7-10 Business Days',
      price: '45,000 PKR',
  ...
  { title: "Technical Support", icon: Headphones, active: true, path: "/TechnicalSupport" },
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex items-center justify-left gap-x-60 mt-4 px-6">
                ...
                <div className="flex items-center space-x-4 ">
                  ...
                  <span className="text-gray-800 font-medium">Technical support</span>
                </div>
