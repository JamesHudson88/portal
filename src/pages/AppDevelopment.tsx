...
const AppDevelopment = () =>  {
  ...
  const services = [
    {
      ...
      price: '30,000 PKR',
      image: '/public/icons/iOS Applications.png',
      bgColor: 'bg-white'
    },
    {
      id: 'Android App',
      ...
      price: '90,000 PKR',
  image: '/public/icons/Android App.png',
      bgColor: 'bg-white'
    },
    {
      id: 'Flutter Cross-Platform App',
      name: 'Flutter Cross-Platform App',
      category: 'App Development',
      delivery: '10-14 Business Days',
      price: '60,000 PKR',
  image: '/public/icons/Flutter.png',
      bgColor: 'bg-white'
    },
    {
      id: 'Mobile Games Development',
      name: 'Mobile Games Development',
      category: 'App Development',
      delivery: '7-10 Business Days',
      price: '35,000 PKR',
  image: '/public/icons/Games.png',
      bgColor: 'bg-white'
    },
    {
      ...
      delivery: '7-10 Business Days',
      price: '45,000 PKR',
  image: '/public/icons/Business Applications.png',
      bgColor: 'bg-white'
    },
    {
      id: 'Custom App Development – Get a Quote',
      name: 'Custom App Developmeent',
      category: 'App Development',
      delivery: '7-10 Business Days',
      price: '100,000 PKR',
  image: '/public/icons/Custom App Development – Get a Quote.png',
      bgColor: 'bg-white'
    }
  ];
  ...
  { title: "App Development", icon: Smartphone, active: true, path: "/AppDevelopment" },
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex items-center justify-left gap-x-60 mt-4 px-6">
                ...
                <div className="flex items-center space-x-4 ">
                  ...
                  <span className="text-gray-800 font-medium">App Development</span>
                </div>
